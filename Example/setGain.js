...
const initUPS = async function () {
    ...
    if (initialized.success === true) {
        ...
        // change the PG bits ( shunt voltage ) to:
        // "DIV_1_40MV" -> GAIN 1 RANGE ±40 mV
        await NI_INA219.setPGA("DIV_1_40MV");
        console.log("Setting PGA to 1 & ±40 mV");
        console.log("    ");
...
const Main = async function _main() {
    ...
    console.log('----------------------------------------------------');
    console.log("[NICB:Main] - Started, PGA");
